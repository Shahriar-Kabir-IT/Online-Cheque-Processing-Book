...
$printedCheques = $Cheque->ListAllCHQ1($filterStr, $params, "c.ocq_print_datetime", "DESC", $offset, $perPage);
?>
<div class="page-content">
    <h2>Printed Cheques</h2>
        ...
        <form method="GET" action="" class="filter-form">
            <div class="form-row">
                ...
                <div class="form-group" style="display: flex; align-items: flex-end; gap: 10px;">
                    ...
                    <a href="printed_cheques_company.php" class="btn btn-secondary">Clear</a>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="results-info">
        <p>
            ...
            of <?php echo number_format($totalRecords); ?> printed cheques
    ...
    <?php if (empty($printedCheques)): ?>
        <p class="no-data">No printed cheques found<?php echo (!empty($fromDate) || !empty($toDate)) ? ' for the selected date range' : ''; ?>.</p>
    <?php else: ?>
        <div class="table-container">
            <table class="data-table">
                ...
                <tbody>
                    <?php foreach ($printedCheques as $chq): ?>
                        <tr>
